import { Injectable, inject, afterNextRender, Injector, signal, PLATFORM_ID } from '@angular/core';
      ...
      map(response => {
        ...
        if (user && accessToken) {
          this.localStorageService
            .setItem(this.localStorageKeyName, JSON.stringify({...user, accessToken}))
            .then(() => {
