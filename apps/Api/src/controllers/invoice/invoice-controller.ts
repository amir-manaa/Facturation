...
export class InvoiceController {
  ...
  async #getInvoicesByUser(req: express.Request, res: express.Response, next: express.NextFunction) {
    try {
  ...
  async #getInvoices(req: express.Request, res: express.Response, next: express.NextFunction) {
    try {
  ...
  async #updateInvoice(req: express.Request, res: express.Response, next: express.NextFunction) {
    try {
      const invoiceId = req.params.id;
      const reqBody = req.body as Omit<IInvoice, "id">;
